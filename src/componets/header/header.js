...
const Header = () => {
    return (
            ...
            <nav class="navbar-4k-style navbar navbar-expand-lg navbar-dark  sticky-top">
...
<div className="avalid-social mr-auto">
            ...
            <span className="social social-ios">
                <a href="https://itunes.apple.com/us/app/4k-nature-relax-tv/id1403683336?mt=8" target="_blank" rel="nofollow"><i class="fa fa-apple"></i></a>
                <a href="https://play.google.com/store/apps/details?id=xyz.gameoff.relaxation" target="_blank" rel="nofollow"><i class="fa fa-android"></i></a>

                <a href="https://www.amazon.com/Pro-Art-inc-Nature-Relax/dp/B074MC1G9X" target="_blank" rel="nofollow"><i class="fa fa-amazon"></i></a>
         ...
         <div className="more-inform my-2 my-lg-0">
                <a href="subscription" class="bottom-smart" id="navBarStartTrial">
