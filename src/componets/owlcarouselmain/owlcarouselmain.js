...
const OwlCarouselMain = (props) => {
   
   return <React.Fragment><OwlCarousel items={1} className='my-carousel owl-theme  owl-carousel owl-loaded owl-drag' loop margin={10} nav  >
...
</OwlCarousel></React.Fragment>
}

export default OwlCarouselMain;