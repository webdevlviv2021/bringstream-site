    ...
    return (
        ...
        <form id="loginform" className="formWhiteOnBlack formVertical" />
            <div className="loginform subscriptiontab" style="display: block;" />
                ...
                <div className="div-p"><input value="" type="text" className="user-email" name="email" placeholder="Email Address" required="true" pattern="^[a-zA-Z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$" /></div>
                <div className="div-p"><input type="submit" value="Login" /></div>
                <div className="div-p"><div className="hr-half" /><hr></div><div className="hr-or">OR</div><div className="hr-half" /><hr></div></div>
        ...
        <div className="regformsuccess subscriptiontab formWhiteOnBlack" 
        style={{"display": "none;"}}>
